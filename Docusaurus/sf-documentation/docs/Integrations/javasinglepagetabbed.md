...
<Tabs groupId="integrations_java">
...
<TabItem value="Kubernetes-sfKubeAgent" label="Kubernetes-sfKubeAgent">
...
In this sfKubeAgent option, the Java application should be run with Jolokia agent and sfKubeAgent running as a sidecar container and fetches metrics via Jolokia port. Refer to [sfKubeAgent](/docs/New_pages/sfkubeagent_installation) Overview 

 

</TabItem>
  <TabItem value="Kubernetes-Prometheus Exporter" label="Kubernetes-Prometheus Exporter">
