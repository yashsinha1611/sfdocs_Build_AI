# Steps to install SnappyFlow RUM agent - Angular 13 and above

:::note Prerequisites

Any web application developed using Angular version 13 or above.
:::
...
![image](../images/error-handler-13v.png)
